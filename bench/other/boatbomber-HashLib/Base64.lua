...
function Base64.Encode(Input)
	...
	for Index = 1, #Input, 3 do
		...
		A = bit32_rshift(C1, 2)
		B = bit32_lshift(bit32_band(C1, 3), 4) + bit32_rshift(C2 or 0, 4)
		C = bit32_lshift(bit32_band(C2 or 0, 15), 2) + bit32_rshift(C3 or 0, 6)
		D = bit32_band(C3 or 0, 63)
...
function Base64.Decode(Input)
	...
	for Index = 1, #Input, 4 do
		...
		I1 = Indexes[C1] - 1
		I2 = Indexes[C2] - 1
		I3 = (Indexes[C3] or 1) - 1
		I4 = (Indexes[C4] or 1) - 1

		A = bit32_lshift(I1, 2) + bit32_rshift(I2, 4)
		B = bit32_lshift(bit32_band(I2, 15), 4) + bit32_rshift(I3, 2)
