...
mlkem = require("./noise-dir/mlkem768")
keccak = require("./noise-dir/keccak")
...
function runConnection(connIndex: number)
	...
	m1 = noise.writeMessage(alice, p1)
	r1 = noise.readMessage(bob, m1)
	m2 = noise.writeMessage(bob, p2)
	r2 = noise.readMessage(alice, m2)
	m3 = noise.writeMessage(alice, p3)
	r3 = noise.readMessage(bob, m3)
	...
	aliceSend = (alice as any).sendCS
	aliceRecv = (alice as any).recvCS
