...
function test()
	...
	PRIME64_1 = 0x9E3779B185EBCA87i
	PRIME64_2 = 0xC2B2AE3D27D4EB4Fi
	PRIME64_3 = 0x165667B19E3779F9i
	PRIME64_4 = 0x85EBCA77C2B2AE63i
	PRIME64_5 = 0x27D4EB2F165667C5i
	...
	function xxh64(buf, seed)
		...
		if len >= 32 then
			...
			a2 = integer.add(seed, PRIME64_2)
			a3 = seed
			a4 = integer.sub(seed, PRIME64_1)

			while offset <= len - 32 do
				lane1 = buffer.readinteger(buf, offset)
				lane2 = buffer.readinteger(buf, offset + 8)
				lane3 = buffer.readinteger(buf, offset + 16)
				lane4 = buffer.readinteger(buf, offset + 24)
			...
			r1 = integer.mul(integer.lrotate(integer.mul(a1, PRIME64_2), 31i), PRIME64_1)
			hash = integer.add(integer.mul(integer.bxor(hash, r1), PRIME64_1), PRIME64_4)
			r2 = integer.mul(integer.lrotate(integer.mul(a2, PRIME64_2), 31i), PRIME64_1)
			hash = integer.add(integer.mul(integer.bxor(hash, r2), PRIME64_1), PRIME64_4)
			r3 = integer.mul(integer.lrotate(integer.mul(a3, PRIME64_2), 31i), PRIME64_1)
			hash = integer.add(integer.mul(integer.bxor(hash, r3), PRIME64_1), PRIME64_4)
			r4 = integer.mul(integer.lrotate(integer.mul(a4, PRIME64_2), 31i), PRIME64_1)
