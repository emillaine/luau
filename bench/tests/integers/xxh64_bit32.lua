...
function test()
	...
	function mul64(ah, al, bh, bl)
		...
		a2 = bit32.band(ah, 0xFFFF)
		a3 = bit32.rshift(ah, 16)
		b0 = bit32.band(bl, 0xFFFF)
		b1 = bit32.rshift(bl, 16)
	...
	function mergeRound(hh, hl, ach, acl)
		th, tl = mul64(ach, acl, P2h, P2l)
		th, tl = lrotate64(th, tl, 31)
	...
	function xxh64(buf, seedh, seedl)
		...
		if len >= 32 then
			...
			a2h, a2l = add64(seedh, seedl, P2h, P2l)
			a3h, a3l = seedh, seedl
			...
			r1h, r1l = lrotate64(a1h, a1l, 1)
			r2h, r2l = lrotate64(a2h, a2l, 7)
			r3h, r3l = lrotate64(a3h, a3l, 12)
			r4h, r4l = lrotate64(a4h, a4l, 18)
