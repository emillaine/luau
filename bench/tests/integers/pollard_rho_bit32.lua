...
function test()
	...
	function mul32_full(a, b)
		...
		b0 = bit32.band(b, 0xFFFF)
		b1 = bit32.rshift(b, 16)
	...
	function gcd64(ah, al, bh, bl)
		while bh != 0 or bl != 0 do
			rh, rl = rem64(ah, al, bh, bl)
			ah, al = bh, bl
			bh, bl = rh, rl
		end
		return ah, al
	...
	function absdiff64(ah, al, bh, bl)
